...
int main(void)
{
	bool status = FALSE;
	int error;
	SOLOMotorControllersSerial *solo1 = new SOLOMotorControllersSerial((char*)"COM6", 0, SOLOMotorControllersSerial::UartBaudrate::rate115200, 50, 3, false);
