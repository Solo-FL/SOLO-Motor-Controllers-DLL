...
SOLOLIBRARY_API bool SetCanbusBoudrate(CanbusBaudrate canbusBoudrate, int& error);

SOLOLIBRARY_API bool SetCanbusBoudrate(CanbusBaudrate canbusBoudrate);
...
SOLOLIBRARY_API bool serialIsWorking(int& error);

SOLOLIBRARY_API bool serialIsWorking();
